...
int main() {
    std::vector<long long> sizes = {1000000, 5000000, 10000000, 20000000};
    std::vector<int> maxValues = {150, 850, 1850, 2900};

    std::cout << "\n";
    std::cout << "Name: Shreyas Joshi Roll no: 41028 Class: BE A\n";
    std::cout << "\n";
    std::cout << "--------------------------------------------------------------------------------------------------------------------\n";
